...
Describe 'Get-MsIdApplicationIdByAppId' {
    ...
    BeforeAll {
        ...
        Mock -ModuleName $PSModule.Name Get-MgApplication { ConvertFrom-Json '{ "id": "20000000-0000-0000-0000-000000000002" }' } -ParameterFilter { $Filter.Equals("appId eq '10000000-0000-0000-0000-000000000001'") } -Verifiable
        Mock -ModuleName $PSModule.Name Get-MgApplication { ConvertFrom-Json '{ "id": "40000000-0000-0000-0000-000000000004" }' } -ParameterFilter { $Filter.Equals("appId eq '30000000-0000-0000-0000-000000000003'") } -Verifiable
