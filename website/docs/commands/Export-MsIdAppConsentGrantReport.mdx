...
Export-MsIdAppConsentGrantReport [-ExcelWorkbookPath] <String> [[-ReportOutputType] <String>]
 [-PermissionsTableCsvPath <String>] [-ThrottleLimit <Int32>] [-LocalUserCsvPath <String>]
...
Export-MsIdAppConsentGrantReport [[-ReportOutputType] <String>] [-PermissionsTableCsvPath <String>]
 [-ThrottleLimit <Int32>] [-LocalUserCsvPath <String>] [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```
...
```powershell
Get-MgUser -All | Select Id,DisplayName | Export-Csv -NoTypeInformation users.csv
