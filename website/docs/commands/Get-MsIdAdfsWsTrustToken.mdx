...
description: Initiates a Ws-Trust logon request to and AD FS server to generate log activity and returns the user token.
id: Get-MsIdAdfsWsTrustToken
title: Get-MsIdAdfsWsTrustToken
hide_title: false
hide_table_of_contents: false
custom_edit_url: https://github.com/maester365/maester/blob/main/powershell/public/Get-MsIdAdfsWsTrustToken.ps1
---
