...
RequiredModules = @(@{ModuleName = 'Microsoft.Graph.Authentication'; GUID = '883916f2-9184-46ee-b1f8-b6a2fb784cee'; ModuleVersion = '0.0.0'; },
               @{ModuleName = 'ImportExcel'; GUID = '60dd4136-feff-401a-ba27-a84458c57ede'; ModuleVersion = '0.0.0'; })
...
FunctionsToExport = 'Add-MsIdClientSecretToAgentIdentityBlueprint',
               ...
               'New-MsIdAgentIDForAgentIdentityBlueprint', 'Get-MsIdAgentIdentity',
               'Get-MsIdAgentIdentityToken', 'New-MsIdAgentIDUserForAgentId',
               'New-MsIdWsTrustRequest', 'New-MsIdClientSecret',
               'New-MsIdSamlRequest', 'New-MsIdTemporaryUserPassword',
