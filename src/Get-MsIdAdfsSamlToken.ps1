...
.EXAMPLE
    PS C:\>Get-MsIdAdfsSamlToken urn:federation:MicrosoftOnline -HostName adfs.contoso.com
...
.EXAMPLE
    ...
    PS C:\>$SamlIdentifiers | foreach { Get-MsIdAdfsSamlToken $_ -HostName adfs.contoso.com }
